...
//   const handleAddStudentToPlaced = (studentId) => {
//     const newPlacedStudentIds = [...placedStudentIds, studentId];
//     setPlacedStudentIds(newPlacedStudentIds);
//     localStorage.setItem("placedStudentIds", JSON.stringify(newPlacedStudentIds));
//   };
...
//   const isAddedToPlaced = (studentId) =>
//     placedStudentIds.includes(studentId);
...
//               <th className="py-3 px-6 text-left">Actions</th>
//               <th className="py-3 px-6 text-left">Add to Placed</th>
//             </tr>
//           </thead>
//           <tbody className="text-gray-600 text-sm font-light">
//             {roundThreeStudents.map((student) => (
...
//                   ) : (
//                     <button
//                       onClick={() => handleAddStudentToPlaced(student.srno)}
//                       className="bg-green-400 text-white py-1 px-2 rounded hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-green-500"
//                     >
//                       Add to Placed
//                     </button>
//                   )}
